...
import 'package:airmid/src/widget/bottom_bar/body.dart';
import 'package:airmid/src/widget/bottom_bar/dot_nav_bar_item.dart';
...
class DotNavigationBar extends StatelessWidget {
  const DotNavigationBar({
    ...
    this.marginR = const EdgeInsets.symmetric(horizontal: 50, vertical: 0),
    this.paddingR = const EdgeInsets.only(bottom: 5, top: 10),
    this.borderRadius = 30,
    this.splashBorderRadius,
    this.backgroundColor = ConstColor.buttonColor,
